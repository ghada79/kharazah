...
//                     filled: true, // لتفعيل لون الخلفية
//                     fillColor: ColorManager.secondaryColor, // اللون المراد استخدامه للخلفية
//                     labelText: 'Delivery Address',
//                     labelStyle: getMediumStyle(color: ColorManager.primary, fontSize: 14.sp),
//                     border: OutlineInputBorder(
//                       borderRadius: BorderRadius.circular(8), // تعديل الزوايا إذا لزم
//                       borderSide: BorderSide(color: ColorManager.white), // لون الحواف
//                     ),
//                     enabledBorder: OutlineInputBorder(
//                       borderRadius: BorderRadius.circular(8),
//                       borderSide: BorderSide(color: ColorManager.white), // لون الحواف عندما يكون الحقل غير مفعّل
//                     ),
//                     focusedBorder: OutlineInputBorder(
//                       borderRadius: BorderRadius.circular(8),
//                       borderSide: BorderSide(color: ColorManager.white, width: 2), // لون الحواف عندما يكون الحقل مفعّل
//                     ),
//                   ),
//                   style: TextStyle(color: ColorManager.white), // لون النص داخل الحقل
//                 ),
//                 SizedBox(height: 20),
//                 TextField(
//                   controller: _addressController,
